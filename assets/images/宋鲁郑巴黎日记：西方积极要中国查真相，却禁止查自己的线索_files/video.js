...
//            "<table><tr><td><label for=\"eduiVideoUrl\" class=\"edui-video-url\"><%=lang_video_iframe_url%></label></td><td><input id=\"eduiVideoUrl\" type=\"text\"></td></tr></table>" +
...
//            "</div>",
		  ...
		  "<div id=\"eduiVideoFloat\"></div>" +
		  "</fieldset>" +
		  "<p id='eduiVideoTip1'><%=lang_video_tip_1%></p>" +
		  "<p id='eduiVideoTip2'><%=lang_video_tip_2%></p>" +
		  "</div>" +
		  "</div>" +
		  "</div>" +
		  "</div>" +
